(function() {
/**
 * HashTabletable implementation.  This provides a 'length' property that's
...
if(typeof window.HashTable != 'undefined') {
    var _HashTable = window.HashTable;
}

var HashTableTable = window.HashTable = function(args) {
    if(this instanceof arguments.callee) {
        this.init.apply(this, args && args.callee ? args : arguments);
    } else {
        return new HashTable(arguments);
    }
};

HashTable.no_conflict = function() {
    window.HashTable = _HashTable;
    return HashTable;
};
...
HashTable.prototype = {
    ...
    /**
     * Creates a new HashTable.  If the copy_from object is specified, it copies
     ...
     * 
     * @member HashTable
     * @returns {HashTable} The HashTable itself.
     */
    update: function(obj) {
        for(var prop in obj) {
     ...
     * 
     * @member HashTable
     * @returns {HashTable} The hash itself.
     */
    empty: function() {
        this.hash = {};
        this.length = 0;
     ...
     * order, and does not share structure with the HashTable.
     * 
     * @member HashTable
     * @type Array<String>
     */
     ...
     * order, and does not share structure with the HashTable.  Values retain their
     * identities.
     *
     * @member HashTable
     * @type Array<Object>
     ...
     * the original HashTable object and vis versa.  Make a copy if you don't
     * want this behavior.
     *
     * @member HashTable
