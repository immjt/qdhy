...
(function($, version)
{
      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="点击打开颜色面板">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: 'third/jPicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          ...
          tooltips:
          {
            colors:
            {
              newColor: '新颜色 - 点击&ldquo;确定&rdquo;提交',
              currentColor: '点击返回初始颜色'
            },
            buttons:
            {
              ok: '提交所选颜色',
            ...
            hue:
            {
              radio: '设置&ldquo;色调&rdquo;',
              textbox: '输入&ldquo;色调&rdquo;值(0-360&deg;)'
            },
            saturation:
            {
              radio: '设置&ldquo;饱和度&rdquo;',
              textbox: '输入&ldquo;饱和度&rdquo;值(0-100%)'
            },
            value:
            {
              radio: '设置&ldquo;亮度&rdquo;',
              textbox: '输入&ldquo;亮度&rdquo; 值(0-100%)'
            },
            red:
            {
              radio: '设置&ldquo;红&rdquo;色值',
              textbox: '输入&ldquo;红&rdquo;值(0-255)'
            },
            green:
            {
              radio: '设置&ldquo;绿&rdquo;色值',
              textbox: '输入&ldquo;绿&rdquo;值(0-255)'
            },
            blue:
            {
              radio: '设置&ldquo;蓝&rdquo;色值',
              textbox: '输入&ldquo;蓝&rdquo;值(0-255)'
            },
            alpha:
            {
              radio: '设置&ldquo;透明度&rdquo;',
              textbox: '输入&ldquo;透明度&rdquo;值(0-100)'
            },
            hex:
            {
              textbox: '输入&ldquo;十进制&rdquo;颜色值(#000000-#ffffff)',
              alpha: '输入&ldquo;透明度&rdquo;值(#00-#ff)'
            }
          }
        }
    };
